...
public class GetOffers extends AsyncTask<String, Void, OffersMain> {

    private String finalUrl = "http://alskok.com/api_offers";
     private OnLoadCompleteListener callback;
    private Context context;

    public GetOffers(Context context, OnLoadCompleteListener cb) {
         callback = cb;
    ...
    private String makeRequest(String offset) throws Exception {
        ...
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.LIMIT_KEY,"20"));
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.OFFSET_KEY,offset));
