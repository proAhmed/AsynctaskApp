...
public class DeleteImageOffer extends AsyncTask<Integer, Void, NormalResponse> {

    private final static String URL = UrlConstant.BASE_URL+UrlConstant.DELETE_OFFER_IMAGE_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public DeleteImageOffer(Context context, OnLoadCompleteListener cb) {
        callback = cb;
    ...
    @Override
    protected NormalResponse doInBackground(Integer... params) {
    ...
    private String makeRequest(int offerId,int imageId) throws Exception {
        ...
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.OFFER_ID, offerId+""));
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.PHOTO_ID, imageId+""));
