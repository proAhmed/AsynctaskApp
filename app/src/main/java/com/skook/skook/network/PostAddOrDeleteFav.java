...
public class PostAddOrDeleteFav extends AsyncTask<Integer, Void, FavoriteResponse> {

    private final static String URL = UrlConstant.BASE_URL + UrlConstant.ADD_FAVORITE_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public PostAddOrDeleteFav(Context context, OnLoadCompleteListener cb) {
        callback = cb;
