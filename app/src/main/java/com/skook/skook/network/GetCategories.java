...
public class GetCategories extends AsyncTask<String,Void,ArrayList<Categories>> {

     private String finalUrl;
    private OnLoadCompleteListener callback;
    private Context context;
    String responseJSON;
    public GetCategories(Context context, OnLoadCompleteListener cb) {
         callback = cb;
        this.context = context;
        finalUrl = UrlConstant.BASE_URL+UrlConstant.CATEGORIES_URL;
    }
    ...
    protected ArrayList<Categories> doInBackground(String... params) {
        ...
        if (responseJSON != null && responseJSON.length() > 1) {
            ...
            gson = gb.create();
            try {
               obj = (new Gson()).fromJson(responseJSON, new TypeToken<ArrayList<Categories>>() {}.getType());
    ...
    @Override
    protected void onPostExecute(ArrayList<Categories> responseHome) {
