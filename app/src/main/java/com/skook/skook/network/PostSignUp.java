...
public class PostSignUp extends AsyncTask<SignUpInput, Void, SignInModel> {

    private final static String URL = UrlConstant.BASE_URL+UrlConstant.REGISTER_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public PostSignUp(Context context, OnLoadCompleteListener cb) {
        callback = cb;
    ...
    @Override
    protected SignInModel doInBackground(SignUpInput... params) {
