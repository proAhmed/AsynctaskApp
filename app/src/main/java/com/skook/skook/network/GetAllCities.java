...
public class GetAllCities extends AsyncTask<String,Void,ArrayList<Cities>> {
    ...
    public GetAllCities(Context context, OnLoadCompleteListener cb) {
         callback = cb;
        this.context = context;
        finalUrl = UrlConstant.BASE_URL+UrlConstant.CITY_ALL_URL;
    }
