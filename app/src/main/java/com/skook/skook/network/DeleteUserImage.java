...
public class DeleteUserImage extends AsyncTask<Void, Void, NormalResponse> {

    private final static String URL = UrlConstant.BASE_URL+UrlConstant.DELETE_USER_IMAGE_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public DeleteUserImage(Context context, OnLoadCompleteListener cb) {
        callback = cb;
    ...
    @Override
    protected NormalResponse doInBackground(Void... params) {
