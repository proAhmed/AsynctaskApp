...
public class OfferBasedOnRegionApi extends AsyncTask<Integer, Void, OffersMain> {

    private final static String URL = UrlConstant.BASE_URL+UrlConstant.SEARCH_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public OfferBasedOnRegionApi(Context context, OnLoadCompleteListener cb) {
        callback = cb;
        this.context = context;
    }
     @Override
    protected OffersMain doInBackground(Integer... params) {
    ...
    protected void onPostExecute(OffersMain result) {
     ...
     private String makeRequest(Integer searchInput) throws Exception {
        ...
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.SECURE_DATA_KEY, NetworkConstant.SECURE_DATA));
          nameValuePairs.add(new BasicNameValuePair(NetworkConstant.REGION,searchInput+""));
