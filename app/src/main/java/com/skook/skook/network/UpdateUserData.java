...
public class UpdateUserData extends AsyncTask<SignUpInput, Void, NormalResponse> {

    private final static String URL = UrlConstant.BASE_URL+UrlConstant.UPDATE_ACCOUNT_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public UpdateUserData(Context context, OnLoadCompleteListener cb) {
        callback = cb;
    ...
    @Override
    protected NormalResponse doInBackground(SignUpInput... params) {
    ...
    private String makeRequest(SignUpInput contactUsInput) throws Exception {
        ...
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.PASSWORD, contactUsInput.getPassword()));
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.USERNAME, contactUsInput.getUserName()));
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.PHONE, contactUsInput.getPhone()));
