...
public class DeleteUserOffer extends AsyncTask<Integer, Void, NormalResponse> {

    private final static String URL = UrlConstant.BASE_URL+UrlConstant.DELETE_OFFER_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public DeleteUserOffer(Context context, OnLoadCompleteListener cb) {
        callback = cb;
    ...
    private String makeRequest(int offerId) throws Exception {
        ...
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.OFFER, offerId+""));
