...
public class PostForgetPass extends AsyncTask<String, Void, NormalResponse> {

    private final static String URL = UrlConstant.BASE_URL + UrlConstant.FORGOT_PASSWORD_URL;
    private OnLoadCompleteListener callback;
    private Context context;

    public PostForgetPass(Context context, OnLoadCompleteListener cb) {
        callback = cb;
    ...
    private String makeRequest(String phone) throws Exception {
        ...
        nameValuePairs.add(new BasicNameValuePair(NetworkConstant.PHONE, phone));
